...
const routes: Routes = [
  ...
  {path:"admin/themes/:themeId", component: FormThemeComponent, canActivate : [AdminGuardService]},
  {path:"admin/addTheme/forums/:ForumId", component: FormThemeComponent, canActivate : [AdminGuardService]},
